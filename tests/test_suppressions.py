...
class TestBlockDirective:
    @pytest.mark.parametrize(
        ...
        ids=["above_decorated_class", "above_method", "trailing_on_def_line"],
    )
...
class TestFileDirectiveRuleList:
    def test_NamedRule_DropsOnlyThatRuleAcrossTheFile(self) -> None:
